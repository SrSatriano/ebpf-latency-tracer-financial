# Guia de deploy — Tracer de latência eBPF para redes financeiras

> Versão **1.0.0** · Stack: **C eBPF, Python, Grafana, Prometheus**
...
3. Execute `python3 -m pytest tools/tests/ -q` ou smoke tests automatizados.
