# Arquitetura — Tracer de latência eBPF para redes financeiras

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Programas BPF com histogramas exportados para Prometheus/Grafana.
...
|------------|------------------|
| Maps | Maps de histograma no kernel |
| Loader | Loader Python |
| Dashboard | Dashboard Grafana |
| Docker | Docker Compose de observabilidade |
| Guia | Guia de capacidades CAP_BPF |
