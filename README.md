...
# Tracer de latência eBPF para redes financeiras

**Tracer de latência eBPF para redes financeiras**

<p>
  <a href="https://github.com/SrSatriano/ebpf-latency-tracer-financial"><img src="https://img.shields.io/badge/GitHub-ebpf-latency-tracer-financial-24292e?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
</p>
...
<p><strong>RTT em microssegundos no kernel para feeds de bolsa.</strong></p>
...
| | |
|---|---|
| **Problema** | tcpdump em produção adiciona overhead e pouca agregação. |
| **Solução** | Programas BPF com histogramas exportados para Prometheus/Grafana. |

## Para quem é

SREs de infraestrutura de mercado (Linux).

## Casos de uso

- Medir RTT de feed multicast
- Detectar jitter

## Funcionalidades

- [x] Maps de histograma no kernel
- [x] Loader Python
- [x] Dashboard Grafana
- [x] Docker Compose de observabilidade
- [x] Guia de capacidades CAP_BPF

## Stack tecnológica

| Camada | Tecnologias |
|--------|-------------|
| **Principal** | C eBPF, Python, Grafana, Prometheus |

## Arquitetura

```mermaid
flowchart LR
  NIC[Interface rede] --> BPF[eBPF programs]
  BPF --> MAP[Maps histograma]
  MAP --> PY[Loader Python]
  PY --> PROM[Prometheus]
```
...
Linux 5.15+, clang, libbpf, CAP_BPF.
...
|----------|-----------|--------|
| `IFACE` | Interface de captura | `eth0` |
...
<p align="center">Desenvolvido com foco em clareza e engenharia de produção · <a href="https://github.com/SrSatriano/ebpf-latency-tracer-financial">Ver no GitHub</a></p>
