...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [ebpf-latency-tracer-financial](https://github.com/SrSatriano/ebpf-latency-tracer-financial).
